...
const HeroSectionText = ({ align }) => {
  return (
    <div
      className={`p-1 flex flex-col justify-center ${align=='center'?'items-center':align=='start'?'items-start':'items-center'} w-full h-[30rem] gap-3 sm:gap-5`}>
      ...
      <span className="flex sm:flex-row flex-col justify-center items-center gap-2">
        <label htmlFor="email">
          <input
            ...
            className="border-[1px] border-gray-200 focus:outline-1 text-gray-600 focus:outline-purple/50 h-[2.4rem] w-[18rem] capitalize rounded-md px-4"
          />
        </label>
